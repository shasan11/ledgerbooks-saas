...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('posreturns', function (Blueprint $table) {
            ...
            $table->string('return_no', 60)->nullable();
            ...
            $table->foreignUuid('pos_order_id')->nullable()->constrained();
    ...
    {
        Schema::dropIfExists('posreturns');
    }
};
